...
const { data } = await createNewTask({ title: ..., description: ..., dueDate: ..., isCompleted: ..., });
...
// Variables can be defined inline as well.
const ref = createNewTaskRef({ title: ..., description: ..., dueDate: ..., isCompleted: ..., });
...
// Variables can be defined inline as well.
const { data } = await updateTaskCompletion({ id: ..., isCompleted: ..., });
...
// Variables can be defined inline as well.
const ref = updateTaskCompletionRef({ id: ..., isCompleted: ..., });
